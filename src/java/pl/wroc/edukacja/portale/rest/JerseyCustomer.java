...
public class JerseyCustomer {
    ...
    public JerseyCustomer() {
        ...
        webTarget = client.target(BASE_URI).path("portale2018GK/rest/V1/customers/1");
          
    }
    
    public JerseyCustomer(int customerId) {
        ...
        webTarget = client.target(BASE_URI).path("portale2018GK/rest/V1/customers/"+customerId);
